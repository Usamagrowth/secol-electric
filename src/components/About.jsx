    ...
    <section id="about" className="py-10 bg-white">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          {/* Text */}
          <div>
            <h2 className="text-3xl md:text-4xl font-black leading-tight mb-6 text-gray-900">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {values.map(v => (
              <div key={v.title} className="bg-gray-50 border border-gray-200 rounded-xl p-5 hover:border-[#F5C300]/30 transition-colors">
